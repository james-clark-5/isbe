...
testing_prepare_sequential_camera_frames_working(frames_dir, ... 
    'time1_ext', '_t2_',...
    'time2_ext', '_tf_',...
    'image_format', 'bmp',...
...
%not match up)
testing_register_time_camera_frames_working([frames_dir 'corrections\'],...
...
regDif_meanBrightness_array = testing_meanDifImg_multiFolder_working(frames_dir); 
x = 0:59;
figure;
