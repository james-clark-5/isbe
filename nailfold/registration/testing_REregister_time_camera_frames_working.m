...
for iLoops = 1:numLoops % 1:numLoops, if doing a whole analysis
    ...
    if strcmp(range_type, 'time')
        ...
        for i_frame = 1:num_frames
            ...
            [dummy, frame_name] = fileparts(camera1_frame_names);
            clear dummy;
            ...
            [dummy, frame_name] = fileparts(camera2_frame_names);
            clear dummy;
