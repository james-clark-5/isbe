...
frames_dir = 'C:\Users\MPhys2016\Desktop\Occlusion compare 530 500\17.03.07 occlusion compare 530 500\trial 2 Jul LH fing4\17.03.07 - exp60.04 g900 - 530 cam1 - t0t2\';
...
filter_wavelength = 530; %jj DON'T CHANGE THIS. This code is for 500 nm filter ONLY.
trial_number = 1;

%Make dirt image
%You want to use the (out-of-focus) frames you captured especially for this
dirty_dir = 'C:\Users\MPhys2016\Desktop\Occlusion compare 530 500\17.03.07 occlusion compare 530 500\trial 2 Jul LH fing4\17.03.07 530 nm cam 1 dirt/';
...
register_time_camera_frames([frames_dir 'corrections\'],...
    ...
    'camera1_ext', '_t0_',...
    'camera2_ext', '_t2_',...
    'correction_factor', 1,... % this is specific to 500nm. factor of 1 for 560/530
