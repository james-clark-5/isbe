function [dirt_image] = make_dirt_image_function(frames_dir, image_format)
...
%fprintf('DID YOU SPECIFY WHICH WAVELENGTH FILES TO LOOK AT? MAKE_DIRT_IMAGE_FUNCTION.M');
%Get list of frames
frames_list = dir([frames_dir '*C_500_' '*.bmp']);
